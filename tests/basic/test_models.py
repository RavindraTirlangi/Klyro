...
class TestModels(unittest.TestCase):
    def setUp(self):
        ...
        from klyro.models import MODEL_SETTINGS
    ...
    @patch("klyro.models.check_for_dependencies")
    ...
    @patch("klyro.models.check_pip_install_extra")
    def test_check_for_dependencies_bedrock(self, mock_check_pip):
        ...
        from klyro.models import check_for_dependencies
    ...
    def test_klyro_extra_model_settings(self):
        import tempfile
    ...
    @patch("klyro.models.litellm.completion")

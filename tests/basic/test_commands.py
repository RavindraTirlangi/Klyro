...
from klyro.utils import ChdirTemporaryDirectory, GitTemporaryDirectory, make_repo
...
class TestCommands(TestCase):
    ...
    def test_cmd_undo_with_dirty_files_not_in_last_commit(self):
        with GitTemporaryDirectory() as repo_dir:
            ...
            coder.klyro_commit_hashes.add(last_commit_hash)
    ...
    def test_cmd_add_klyroignored_file(self):
        with GitTemporaryDirectory():
            repo = git.Repo()
    ...
    def test_cmd_model_preserves_explicit_edit_format(self):
        ...
        with mock.patch("klyro.models.sanity_check_models"):
    ...
    def test_cmd_ask(self):
        ...
        with mock.patch("klyro.coders.Coder.run") as mock_run:

...
from klyro.coders.base_coder import FinishReasonLength, UnknownEditFormat
...
from klyro.sendchat import sanity_check_messages
...
"""
    ...
    def test_skip_klyroignored_files(self):
        with GitTemporaryDirectory():
            repo = git.Repo()
            ...
            aignore = Path(".klyroignore")
            aignore.write_text(f"{fname1}\n{fname2}\ndir\n")
            repo = GitRepo(
                io,
                fnames,
                None,
                klyro_ignore_file=str(aignore),
            )
...
This command will print 'Hello, World!' to the console."""
    ...
    def test_normalize_language(self):
        ...
        with patch("klyro.coders.base_coder.Locale", None):
        ...
        with patch("klyro.coders.base_coder.Locale", mock_babel_locale):
        ...
        with patch("klyro.coders.base_coder.Locale", mock_babel_locale_error):
    ...
    def test_architect_coder_auto_accept_true(self):
        with GitTemporaryDirectory():
            ...
            with patch("klyro.coders.architect_coder.AskCoder.__init__", return_value=None):
                from klyro.coders.architect_coder import ArchitectCoder
                ...
                with patch("klyro.coders.architect_coder.Coder.create", return_value=mock_editor):

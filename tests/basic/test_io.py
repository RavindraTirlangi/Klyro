...
from klyro.io import AutoCompleter, ConfirmGroup, InputOutput
from klyro.utils import ChdirTemporaryDirectory
...
class TestInputOutput(unittest.TestCase):
    ...
    def test_get_input_is_a_directory_error(self, mock_input):
        ...
        with patch("klyro.io.open", side_effect=IsADirectoryError):
...
class TestInputOutputMultilineMode(unittest.TestCase):
    ...
    def test_ensure_hash_prefix(self):
        ...
        from klyro.io import ensure_hash_prefix
...
@patch("klyro.io.is_dumb_terminal", return_value=False)

...
def get_dirs_from_leaderboard():
    ...
    with open("klyro/website/_data/polyglot_leaderboard.yml") as f:
...
def load_results(dirname):
    ...
    for fname in benchmark_dir.glob("*/exercises/practice/*/.klyro.results.json"):
        error = False
        try:
                ...
                pass_rate = next(
                    (
                        ...
                        for entry in yaml.safe_load(
                            open("klyro/website/_data/polyglot_leaderboard.yml")
                        )

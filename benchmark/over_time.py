...
class BenchmarkPlotter:
    ...
    def save_and_display(self, fig: plt.Figure):
        plt.savefig("klyro/website/assets/models-over-time.png")
        plt.savefig("klyro/website/assets/models-over-time.svg")
        imgcat(fig)
...
def main():
    ...
    models = plotter.load_data("klyro/website/_data/edit_leaderboard.yml")
    ...
    plotter.plot("klyro/website/_data/edit_leaderboard.yml")

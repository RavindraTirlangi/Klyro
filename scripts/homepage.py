...
# Badge tooltip texts
GITHUB_STARS_TOOLTIP = "Total number of GitHub stars the Klyro project has received"
PYPI_DOWNLOADS_TOOLTIP = "Total number of installations via pip from PyPI"
TOKENS_WEEKLY_TOOLTIP = "Number of tokens processed weekly by Klyro users"
OPENROUTER_TOOLTIP = "Klyro's ranking among applications on the OpenRouter platform"
SINGULARITY_TOOLTIP = "Percentage of the new code in Klyro's last release written by Klyro itself"

# Cache settings
CACHE_DIR = os.path.expanduser("~/.cache/klyro-badges")
...
def get_github_stars(repo="RavindraTirlangi/klyro"):
    """
...
def get_latest_release_klyro_percentage():
    """
    Get the percentage of code written by Klyro in the LATEST release
    ...
    try:
        ...
        if latest_release:
            percentage = latest_release.get("klyro_percentage", 0)
...
def generate_badges_md(downloads, stars, klyro_percentage):
    """
...
src="https://img.shields.io/badge/🏆%20OpenRouter-Top%2020-9b59b6?style=flat-square&labelColor=555555"/></a>
  <a href="https://klyro.chat/HISTORY.html"><img alt="Singularity" title="{SINGULARITY_TOOLTIP}"
src="https://img.shields.io/badge/🔄%20Singularity-{klyro_percent_rounded}%25-e74c3c?style=flat-square&labelColor=555555"/></a>"""  # noqa
...
def get_badges_md():
    ...
    # Get Klyro contribution percentage in latest release
    percentage, _ = get_latest_release_klyro_percentage()
...
<a href="/HISTORY.html" class="github-badge badge-coded" title="{SINGULARITY_TOOLTIP}">
    ...
    <span class="badge-value">{klyro_percent_rounded}%</span>
</a>"""  # noqa
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Get total downloads and GitHub stars for klyro")
    parser.add_argument(
        "--api-key",
        help=(
    ...
    parser.add_argument(
        ...
        help="GitHub repository (default: RavindraTirlangi/klyro)",
    )
    ...
    # Get Klyro contribution percentage in latest release
    percentage, version = get_latest_release_klyro_percentage()
    print(f"Klyro wrote {percentage:.2f}% of code in the LATEST release ({version})")

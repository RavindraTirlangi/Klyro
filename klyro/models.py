...
from klyro.openrouter import OpenRouterModelManager
from klyro.sendchat import ensure_alternating_roles, sanity_check_messages
from klyro.utils import check_pip_install_extra
...
MODEL_ALIASES = {
    ...
    "r1-lite": "openrouter/deepseek/deepseek-r1-0528:free",
    # ── Mistral ───────────────────────────────────────────────────────────────
    ...
    # ── OpenRouter (free & featured) ─────────────────────────────────────────
    "quasar": "openrouter/openrouter/quasar-alpha",
    "optimus": "openrouter/openrouter/optimus-alpha",
    "llama-free": "openrouter/meta-llama/llama-3.1-8b-instruct:free",
    "llama3.1-free": "openrouter/meta-llama/llama-3.1-8b-instruct:free",
...
MODEL_SETTINGS = []
with importlib.resources.open_text("klyro.resources", "model-settings.yml") as f:
...
class Model(ModelSettings):
    def __init__(
        ...
        self.extra_model_settings = next(
            (ms for ms in MODEL_SETTINGS if ms.name == "klyro/extra_params"), None
        )
    ...
    def configure_model_settings(self, model):
        ...
        if (
            ...
            and self.extra_model_settings.name == "klyro/extra_params"
        ):
    ...
    def send_completion(self, messages, functions, stream, temperature=None):
        if os.environ.get("KLYRO_SANITY_CHECK_TURNS"):
        ...
        if "GITHUB_COPILOT_TOKEN" in os.environ:
            if "extra_headers" not in kwargs:
                kwargs["extra_headers"] = {
                    "Editor-Version": f"klyro/{__version__}",
    ...
    def simple_send_with_retries(self, messages):
        ...
        while True:
            try:
                ...
                from klyro.reasoning_tags import remove_reasoning_content

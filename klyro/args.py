...
from klyro import __version__
from klyro.args_formatter import (
    DotEnvFormatter,
    MarkdownHelpFormatter,
    YamlHelpFormatter,
)
from klyro.deprecated import add_deprecated_model_args

from .dump import dump  # noqa: F401


def resolve_klyroignore_path(path_str, git_root=None):
    path = Path(path_str)
    if path.is_absolute():
        return str(path)
    elif git_root:
...
def get_parser(default_config_files, git_root):
    parser = configargparse.ArgumentParser(
        description="klyro is AI pair programming in your terminal",
        add_config_file_help=True,
        default_config_files=default_config_files,
        config_file_parser_class=configargparse.YAMLConfigFileParser,
        auto_env_var_prefix="KLYRO_",
    )
    ...
    from klyro import coders as _klyro_coders

    edit_format_choices = sorted(
        {
            c.edit_format
            for c in _klyro_coders.__all__
    ...
    group.add_argument(
        ...
        help="Specify a file with klyro model settings for unknown models",
    ).complete = shtab.FILE
    group.add_argument(
        "--model-metadata-file",
    ...
    default_input_history_file = (
        os.path.join(git_root, ".klyro.input.history") if git_root else ".klyro.input.history"
    )
    default_chat_history_file = (
        os.path.join(git_root, ".klyro.chat.history.md") if git_root else ".klyro.chat.history.md"
    )
    group.add_argument(
        "--input-history-file",
    ...
    group.add_argument(
        ...
        default=None,
        help="Log the conversation with the LLM to this file (for example, .klyro.llm.history)",
    ).complete = shtab.FILE
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Enable/disable adding .klyro* to .gitignore (default: True)",
    )
    group.add_argument(
        "--add-gitignore-files",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Enable/disable the addition of files listed in .gitignore to Klyro's editing scope.",
    )
    default_klyroignore_file = (
        os.path.join(git_root, ".klyroignore") if git_root else ".klyroignore"
    )

    group.add_argument(
        "--klyroignore",
        metavar="KLYROIGNORE",
        type=lambda path_str: resolve_klyroignore_path(path_str, git_root),
        default=default_klyroignore_file,
        help="Specify the klyro ignore file (default: .klyroignore in git root)",
    ).complete = shtab.FILE
    group.add_argument(
        "--subtree-only",
        action="store_true",
    ...
    group.add_argument(
        ...
        default=None,
        help=(
            "Attribute klyro code changes in the git author name (default: True). If explicitly set"
    ...
    group.add_argument(
        ...
        default=None,
        help=(
            "Attribute klyro commits in the git committer name (default: True). If explicitly set"
            " to True, overrides --attribute-co-authored-by precedence for klyro edits."
        ),
    )
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix commit messages with 'klyro: ' if klyro authored the changes (default: False)",
    )
    group.add_argument(
        "--attribute-commit-message-committer",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix all commit messages with 'klyro: ' (default: False)",
    )
    group.add_argument(
        ...
        default=True,
        help=(
            "Attribute klyro edits using the Co-authored-by trailer in the commit message"
    ...
    group.add_argument(
        "--check-update",
        action=argparse.BooleanOptionalAction,
        help="Check for new klyro versions on launch",
        default=True,
    )
    group.add_argument(
        "--show-release-notes",
    ...
    group.add_argument(
        ...
        "--update",
        action="store_true",
        help="Upgrade klyro to the latest version from PyPI",
        default=False,
    )
    group.add_argument(
        "--version",
    ...
    group.add_argument(
        ...
        "--browser",
        action=argparse.BooleanOptionalAction,
        help="Run klyro in your browser (default: False)",
        default=False,
    )
    group.add_argument(
        "--copy-paste",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Enable automatic copy/paste of chat between klyro and web UI (default: False)",
    )
    group.add_argument(
        "--apply",
        metavar="FILE",
    ...
    group.add_argument(
        ...
        metavar="CONFIG_FILE",
        help=(
            "Specify the config file (default: search for .klyro.conf.yml in git root, cwd"
            " or home directory)"
        ),
    ).complete = shtab.FILE
    ...
    group.add_argument(
        ...
        help=(
            ...
            f" {', '.join(supported_shells_list)}. Example: klyro --shell-completions bash"
        ),
    )

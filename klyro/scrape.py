...
from klyro import __version__, urls, utils
from klyro.dump import dump  # noqa: F401

klyro_user_agent = f"Klyro/{__version__} +{urls.website}"
...
class Scraper:
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({klyro_user_agent})"}
        try:
            with httpx.Client(

...
install() {
    ...
    say ""
    say "Installing klyro..."
    say ""
    # Install klyro-chat using the newly installed uv
    ensure "${_install_dir}/uv" tool install --force --python python3.12 --with pip klyro-chat@latest

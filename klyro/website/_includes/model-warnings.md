...
If you specify a model that klyro has never heard of, you will get
this warning.
This means klyro doesn't know the context window size and token costs
for that model.
Klyro will use an unlimited context window and assume the model is free,
...
If klyro isn't familiar with the model you've specified,
...
Klyro is unable verify the environment because it doesn't know
which variables are required for the model.
If required variables are missing,
you may get errors when you attempt to chat with the model.
You can look in the [klyro's LLM documentation](/docs/llms.html)
or the

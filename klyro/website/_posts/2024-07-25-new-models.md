...
[klyro's code editing leaderboard](https://klyro.chat/docs/leaderboards/)
...
$ klyro --model deepseek/deepseek-coder

$ export MISTRAL_API_KEY=your-key-goes-here
$ klyro --model mistral/mistral-large-2407

$ export OPENROUTER_API_KEY=your-key-goes-here
$ klyro --model openrouter/meta-llama/llama-3.1-405b-instruct
$ klyro --model openrouter/meta-llama/llama-3.1-70b-instruct
$ klyro --model openrouter/meta-llama/llama-3.1-8b-instruct
```

See the
[installation instructions](https://klyro.chat/docs/install.html)
and other
[documentation](https://klyro.chat/docs/usage.html)
for more details.
...
secured #7 on klyro's leaderboard, 
...
Mistral Large 2 (2407) scored only 60% on klyro's code editing
benchmark. 

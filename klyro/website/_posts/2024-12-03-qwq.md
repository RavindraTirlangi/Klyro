...
This is similar to OpenAI's o1 models, which are most effective with klyro
[when paired as an architect with a traditional LLM as an editor](https://klyro.chat/2024/09/26/architect.html).
...
[editing format](https://klyro.chat/docs/more/edit-formats.html).
...
[details matter with open source models](https://klyro.chat/2024/11/21/quantization.html).

---
title: Claude 3 beats GPT-4 on Klyro's code editing benchmark
excerpt: Claude 3 Opus outperforms all of OpenAI's models on Klyro's code editing benchmark, making it the best available model for pair programming with AI.
...
# Claude 3 beats GPT-4 on Klyro's code editing benchmark

[![benchmark results](/assets/2024-03-07-claude-3.svg)](https://klyro.chat/assets/2024-03-07-claude-3.svg)
...
## Klyro's code editing benchmark
...
2. If any tests failed, klyro sends the LLM the failing test output and gives it a second try to complete the task.
...
Klyro uses more efficient
[search/replace blocks](https://klyro.chat/2023/07/02/benchmarks.html#diff)
with the original GPT-4
and
[unified diffs](https://klyro.chat/2023/12/21/unified-diffs.html#unified-diff-editing-format)
...
- The Claude APIs seem somewhat unstable, returning HTTP 5xx errors of various sorts. Klyro automatically recovers from these errors with exponential backoff retries, but it's a sign that Anthropic made be struggling under surging demand.

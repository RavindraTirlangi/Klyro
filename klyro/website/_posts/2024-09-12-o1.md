---
title: o1-preview is SOTA on the klyro leaderboard
...
# OpenAI o1-preview is SOTA on the klyro leaderboard
...
OpenAI o1-preview scored 79.7% on klyro's code editing benchmark,
...
It is much more practical to use klyro's
...
The o1-preview model had trouble conforming to klyro's diff edit format.
The o1-mini model had trouble conforming to both the whole and diff edit formats.
Klyro is extremely permissive and tries hard to accept anything close
...
It seems likely that klyro could optimize its prompts and edit formats to
better harness the o1 models.


## Using klyro with o1

OpenAI's new o1 models are supported in v0.57.0 of klyro:

```
klyro --model o1-mini
klyro --model o1-preview
```

{: .note }
> These are initial benchmark results for the o1 models,
> based on klyro v0.56.1-dev.
> See the [klyro leaderboards](/docs/leaderboards/) for up-to-date results
> based on the latest klyro releases.

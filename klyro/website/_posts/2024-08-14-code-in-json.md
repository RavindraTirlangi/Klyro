...
> Figure 1: Klyro coding benchmark scores of models using either plain markdown text or JSON to return code.
...
People often ask why klyro uses a plain text format for LLMs to specify code edits (below),
...
Previous [klyro benchmark results](/2023/07/02/benchmarks.html)
showed
...
the 
[klyro "code editing" benchmark](/2023/07/02/benchmarks.html#the-benchmark)
...
klyro's "whole" edit format, where the
...
#### Notes on the klyro leaderboard

*The results presented here are not directly comparable to results
from the main
[klyro LLM leaderboard](https://klyro.chat/docs/leaderboards/).

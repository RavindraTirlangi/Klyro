...
excerpt: Sonnet's score on the klyro code editing benchmark has been stable since it launched.
...
[klyro code editing benchmark](/docs/benchmarks.html#the-benchmark)
via the API.
...
to evaluate the effects of small changes to klyro's system prompts.
...
> The 
> [klyro LLM code editing leaderboard](https://klyro.chat/docs/leaderboards/)

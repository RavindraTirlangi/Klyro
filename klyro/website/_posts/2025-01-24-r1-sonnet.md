---
title: R1+Sonnet set SOTA on klyro's polyglot benchmark
excerpt: R1+Sonnet has set a new SOTA on the klyro polyglot benchmark. At 14X less cost compared to o1.
...
# R1+Sonnet set SOTA on klyro's polyglot benchmark
{: .no_toc }

<canvas id="editChart" width="800" height="450" style="margin-top: 20px"></canvas>

Klyro supports [using a pair of models for coding](https://klyro.chat/2024/09/26/architect.html):
...
[klyro polyglot benchmark](/2024/12/21/polyglot.html).
...
Once you [install klyro](https://klyro.chat/docs/install.html),
you can use klyro, R1 and Sonnet like this:

```bash
export DEEPSEEK_API_KEY=<your-key>
export ANTHROPIC_API_KEY=<your-key>

klyro --architect --model r1 --editor-model sonnet
```
...
klyro --architect --model openrouter/deepseek/deepseek-r1 --editor-model openrouter/anthropic/claude-3.5-sonnet
```

## Thinking output

There has been 
[some recent discussion](https://github.com/RavindraTirlangi/Klyro/pull/2973)
...
final output. 
R1 is configured in klyro's standard architect role with Sonnet as editor.

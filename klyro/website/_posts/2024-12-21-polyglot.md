---
title: o1 tops klyro's new polyglot leaderboard
excerpt: o1 scores the top result on klyro's new multi-language, more challenging coding benchmark.
...
# o1 tops klyro's new polyglot leaderboard
{: .no_toc }
...
new 
[klyro polyglot leaderboard](/docs/leaderboards/), significantly ahead of
other top LLMs.
The new polyglot benchmark uses many popular coding languages
and was designed to be 
*much more challenging* than klyro's original
...
{: .note :}
See the main 
[klyro leaderboard](https://klyro.chat/docs/leaderboards/)
...
Like klyro's original code editing benchmark,
...
Klyro's original code editing benchmark was 
...
[klyro polyglot benchmark repo](https://github.com/Klyro-AI/polyglot-benchmark)
on GitHub.

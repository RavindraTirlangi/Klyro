...
excerpt: OpenAI's GPT-4 Turbo with Vision model scores worse on klyro's code editing benchmarks than all the previous GPT-4 models. In particular, it seems much more prone to "lazy coding" than the existing GPT-4 Turbo "preview" models.
...
and it performs worse on klyro's coding benchmark suites than all the previous GPT-4 models.
In particular, it seems much more prone to "lazy coding" than the
existing GPT-4 Turbo "preview" models.

## Code editing skill

[![benchmark results](/assets/2024-04-09-gpt-4-turbo.svg)](https://klyro.chat/assets/2024-04-09-gpt-4-turbo.svg)

Klyro relies on a
[code editing benchmark](https://klyro.chat/docs/benchmarks.html#the-benchmark)
...
[![benchmark results](/assets/2024-04-09-gpt-4-turbo-laziness.svg)](https://klyro.chat/assets/2024-04-09-gpt-4-turbo-laziness.svg)
...
Klyro uses a ["laziness" benchmark suite](https://github.com/Klyro-AI/refactor-benchmark)
...
**The new GPT-4 Turbo with Vision model scores only 34% on klyro's
refactoring benchmark, making it the laziest coder of all the GPT-4 Turbo models
by a significant margin.**

# Conclusions

Klyro has full support for the new GPT-4 Turbo with Vision
model, which you can access using the switch `--model gpt-4-turbo-2024-04-09`.
But klyro will continue to use `gpt-4-1106-preview` by default,

...
parent: Usage
nav_order: 901
description: Use klyro to edit configuration files, documentation, and other text-based formats.
---


# Editing config & text files

Klyro isn't just for code, it can be very helpful when editing
almost any text file.
You can use klyro to make changes to your shell & ssh settings, 
Dockerfiles
...
<div class="chat-transcript" markdown="1">
$ klyro Dockerfile docker-compose.yml

...
parent: Usage
nav_order: 100
description: Speak with klyro about your code!
---

# Voice-to-code with klyro

Speak with klyro about your code! Request new features, test cases or bug fixes using your voice and let klyro do the work of editing the files in your local git repo. As with all of klyro's capabilities, you can use voice-to-code with an existing repo or to start a new project.

Voice support fits quite naturally into klyro's AI pair programming
chat interface. Now you can fluidly switch between voice and text chat
when you ask klyro to edit your code.
...
the klyro chat session.

See the [installation instructions](https://klyro.chat/docs/install/optional.html#enable-voice-coding) for
...
> Commit ef9e3e7 klyro: Add a factorial endpoint that uses math.factorial.  

...
nav_order: 30
has_children: true
description: How to use klyro to pair program with AI and edit code in your local git repo.
---

# Usage

Run `klyro` with the source code files you want to edit.
These files will be "added to the chat session", so that
klyro can see their
contents and edit them for you.
They can be existing files or the name of files you want
klyro to create for you.

```
klyro <file1> <file2> ...
```

At the klyro `>` prompt, ask for code changes and klyro
...
Do this
by naming them on the klyro command line.
...
Klyro will automatically
pull in content from related files so that it can
[understand the rest of your code base](https://klyro.chat/docs/repomap.html).

You can use klyro without adding any files,
...
edited. Add **just** those files to the chat. Klyro will include
...
Or you can run `klyro --model XXX` to launch klyro with
another model.
...
Ask klyro to make changes to your code.
It will show you some diffs of the changes it is making to
complete you request.
[Klyro will git commit all of its changes](/docs/git.html),

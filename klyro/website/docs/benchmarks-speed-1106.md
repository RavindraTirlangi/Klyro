...
excerpt: This report provides a detailed comparison of the speed of GPT-4 Turbo and gpt-3.5-turbo-1106 models based on the klyro benchmarking suite.
canonical_url: https://klyro.chat/2023/11/06/benchmarks-speed-1106.html
...
reports to get more background on klyro's benchmark suite:
...
- [Code editing skill benchmarks for OpenAI's "1106" models](https://klyro.chat/docs/benchmarks-1106.html) compares the olders models to the November (1106) models.

## Speed

This report compares the **speed** of the various GPT models.
Klyro's benchmark measures the response time of the OpenAI chat completion

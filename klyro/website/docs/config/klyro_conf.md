...
nav_order: 15
description: How to configure klyro with a YAML config file.
---

# YAML config file

Most of klyro's options can be set in an `.klyro.conf.yml` file.
Klyro will look for a this file in these locations:
...
Path("klyro/website/assets/sample.klyro.conf.yml").write_text(text)
cog.outl("```")
cog.out(text)
cog.outl("```")
]]]-->
...
#model-settings-file: .klyro.model.settings.yml

## Specify a file with context window and costs for unknown models
#model-metadata-file: .klyro.model.metadata.json
...
#input-history-file: .klyro.input.history

## Specify the chat history file (default: .klyro.chat.history.md)
#chat-history-file: .klyro.chat.history.md

...
Klyro lets you specify API keys in a few ways:

- On the command line
- As environment variables
- In a `.env` file
- In your `.klyro.conf.yml` config file

---

## OpenAI and Anthropic

Klyro has special support for providing
...
[YAML config file](/docs/config/klyro_conf.html), like this:
...
[`.klyro.conf.yml` file](/docs/config/klyro_conf.html)

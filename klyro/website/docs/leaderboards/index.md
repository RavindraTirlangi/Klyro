...
# Klyro LLM Leaderboards

Klyro excels with LLMs skilled at writing and *editing* code,
and uses benchmarks to
evaluate an LLM's ability to follow instructions and edit code successfully without
human intervention.
[Klyro's polyglot benchmark](https://klyro.chat/2024/12/21/polyglot.html#the-polyglot-benchmark) tests LLMs on 225 challenging Exercism coding exercises across C++, Go, Java, JavaScript, Python, and Rust.

<h2 id="leaderboard-title">Klyro polyglot coding leaderboard</h2>
...
files = [
    ...
    'klyro/website/_data/polyglot_leaderboard.yml',
]

...
[![benchmark results](/assets/benchmarks-0125.svg)](https://klyro.chat/assets/benchmarks-0125.svg)
...
klyro's existing
[lazy coding benchmark](https://klyro.chat/docs/unified-diffs.html).
...
- It gets worse benchmark scores when using the [unified diffs](https://klyro.chat/docs/unified-diffs.html) code editing format.
- Using klyro's older SEARCH/REPLACE block editing format, the new January model outperforms the older November model. But it still performs worse than both models using unified diffs.
...
- [Code editing benchmarks for OpenAI's "1106" models](https://klyro.chat/docs/benchmarks-1106.html).
- [Klyro's lazy coding benchmark](https://klyro.chat/docs/unified-diffs.html).

...
parent: More info
nav_order: 490
description: Klyro uses various "edit formats" to let LLMs edit source files.
---

# Edit formats

Klyro uses various "edit formats" to let LLMs edit source files.
Different models work better or worse with different edit formats.
Klyro is configured to use the optimal format for most popular, common models.
...
The actual edit format is the same, but klyro uses a simpler prompt that

...
Klyro can collect anonymous analytics to help
improve klyro's ability to work with LLMs, edit code and complete user requests.
...
Klyro collects information on:

- which LLMs are used and with how many tokens,
- which of klyro's edit formats are used,
...
If this is the first time you have enabled analytics, klyro
...
klyro will enable analytics for a random subset of users.
...
Klyro respects your privacy and never collects your code, prompts, chats, keys or any personal
info.
For more info: https://klyro.chat/docs/more/analytics.html
Allow collection of anonymous analytics to help improve klyro? (Y)es/(N)o [Yes]:
```
...
Since klyro is open source, all the places where klyro collects analytics
are visible in the source code.
They can be viewed using 
[GitHub search](https://github.com/search?q=repo%3Aklyro-ai%2Fklyro+%22.event%28%22&type=code).


### Logging and inspecting analytics

You can get a full log of the analytics that klyro is collecting,
in case you would like to audit or inspect this data.

```
klyro --analytics-log filename.jsonl
```

If you want to just log analytics without reporting them, you can do:

```
klyro --analytics-log filename.jsonl --no-analytics
```

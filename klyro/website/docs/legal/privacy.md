...
We do not knowingly collect, maintain, or use personal information from children under 18 years of age, and no part of our Service(s) is directed to children. If you learn that a child has provided us with personal information in violation of this Privacy Policy, then you may alert us at privacy@klyro.chat.
...
If you have any questions, comments, or concerns about our processing activities, please email us at privacy@klyro.chat.
...
result = subprocess.run(['git', 'log', '-1', '--format=%ct', 'klyro/website/docs/legal/privacy.md'], capture_output=True, text=True)

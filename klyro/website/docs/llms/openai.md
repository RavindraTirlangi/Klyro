...
Start working with klyro and OpenAI on your codebase:
...
klyro --list-models openai/
```

You can use `klyro --model <model-name>` to use any other OpenAI model.
For example, if you want to use a specific version of GPT-4 Turbo
you could do `klyro --model gpt-4-0125-preview`.
...
Klyro is configured to work properly with these models

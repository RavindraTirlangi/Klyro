...
Klyro can connect to [models provided by OpenRouter](https://openrouter.ai/models?o=top-weekly):
...
Start working with klyro and OpenRouter on your codebase:
...
klyro --model openrouter/<provider>/<model>

# List models available from OpenRouter
klyro --list-models openrouter/
```

In particular, many klyro users access Sonnet via OpenRouter:
...
2. By configuring "provider routing" in a `.klyro.model.settings.yml` file.
...
See [Advanced model settings](https://klyro.chat/docs/config/adv-model-settings.html#model-settings)

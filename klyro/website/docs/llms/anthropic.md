...
Start working with klyro and Anthropic on your codebase:

```bash
# Change directory into your codebase
cd /to/your/project

# Klyro uses Claude 3.7 Sonnet by default
klyro

# List models available from Anthropic
klyro --list-models anthropic/
```
...
You can use `klyro --model <model-name>` to use any other Anthropic model.
For example, if you want to use a specific version of Opus
you could do `klyro --model claude-3-opus-20240229`.

## Thinking tokens

Klyro can work with Sonnet 3.7's new thinking tokens, but does not ask Sonnet to use
thinking tokens by default.

Enabling thinking currently requires manual configuration.
You need to add the following to your `.klyro.model.settings.yml` 

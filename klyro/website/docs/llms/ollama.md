...
Klyro can connect to local Ollama models.
...
Start working with klyro and Ollama on your codebase:
...
which is very small for working with klyro.
...
By default, klyro sets Ollama's context window 
...
with an
[`.klyro.model.settings.yml` file](https://klyro.chat/docs/config/adv-model-settings.html#model-settings)
like this:

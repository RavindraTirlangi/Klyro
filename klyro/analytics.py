...
from klyro.models import model_info_manager
...
class Analytics:
    ...
    def get_data_file_path(self):
        try:
            data_file = Path.home() / ".klyro" / "analytics.json"
    ...
    def posthog_error(self):
        ...
        # https://github.com/RavindraTirlangi/Klyro/issues/2532
        self.ph = None

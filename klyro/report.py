...
from klyro.urls import github_issues
from klyro.versioncheck import VERSION_CHECK_FNAME
...
def report_github_issue(issue_text, title=None, confirm=True):
    ...
    :return: None
    """
    version_info = f"Klyro version: {__version__}\n"
    ...
    if confirm:
        ...
        print()
        print("Please consider reporting this bug to help improve klyro!")
